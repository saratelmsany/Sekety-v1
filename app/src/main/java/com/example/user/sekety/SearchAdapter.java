...
public class SearchAdapter extends ArrayAdapter<ParseUser> {
    private List<ParseUser> mFriend;
    ...
    public SearchAdapter(Context context, List<ParseUser> friend) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String username = object.getUsername().toString();
        holder.textView.setText(username);
        //follow
       /* int follows = object.getInt("follow");
        holder.follow.setText("" + follows + "follow");
        //following
        int following = object.getInt("follow");15
